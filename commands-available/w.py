...
city_id = "101020100"
cs=json.loads( city_id_json )
for province in  cs["城市代码".decode("UTF-8")]:
    for city in province["市".decode("UTF-8")]:
        if city["市名".decode("UTF-8")] ==  city_name.decode("UTF-8") :
            #print city["市名".decode("UTF-8")].encode("UTF-8")
            city_id = city["编码".decode("UTF-8")].encode("UTF-8")
